...
if (isset($_POST["submit"])) {
    ...
    if (!empty($errors)) {
        ...
        foreach ($errors as $error) {
            header("location: ../../../frontend/Dashboard/Admin Dashboard/addUser.php?error=$error");
            exit();
                }
    } else {
        ...
        if ($insert === true) {
            ...
            header("location: ../../../frontend/Dashboard/Admin Dashboard/addUser.php.php?registerError=something went wrong");
        }
